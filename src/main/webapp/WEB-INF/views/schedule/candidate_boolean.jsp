      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="list-group">
            ...
            <a href="${R}user/reportConfirm" class="list-group-item ">보고서 확인</a>
            <a href="${R}user/survey" class="list-group-item ">설문조사 관리</a>
            <a href="${R}user/schedule" class="list-group-item active">멘토, 멘티 신청기간 여부</a>
        ...
        <!-- /.col-lg-3 -->
        <div class="col-md-9">
          <h1 class="my-4"><strong>멘토, 멘티 신청기간 여부</strong></h1>
          <hr/>
        <form method="post">
        <div class="section">
          <label class="title"><strong>멘토 기간 설정 </strong></label>
          <label class="switch">
        ...
        <div class="during">
          <div>
             <strong>멘토 신청기간 시작일: </strong> &nbsp;&nbsp;&nbsp;
                <input type="date" class="form-inline" name="startDate1" value="${schedule1.startDate }"> 부터
              
              <br/>
          </div>
            <br/> 
          <div>
             <strong>멘토 신청기간 종료일: </strong> &nbsp;&nbsp;&nbsp;
                <input type="date" class="form-inline" name="endDate1" value="${ schedule1.endDate}"> 까지
        ...
        <div class="section">
          ...
          <label class="title"><strong>멘티 기간 설정 </strong></label>
          <label class="switch">
        ...
        <div class="during">
          <div>
            ...
            <strong>멘티 신청기간 시작일: </strong> &nbsp;&nbsp;&nbsp;
                <input type="date" class="form-inline" name="startDate2" value="${schedule2.startDate }"> 부터
        ...
        <iframe src="https://calendar.google.com/calendar/embed?title=%EB%A9%98%ED%86%A0%EB%A7%81%20%EC%9D%BC%EC%A0%95&amp;height=600&amp;wkst=1&amp;hl=ko&amp;bgcolor=%23FFFFFF&amp;src=ko.south_korea%23holiday%40group.v.calendar.google.com&amp;color=%23125A12&amp;ctz=Asia%2FSeoul" style="border-width:0" width="800" height="600" frameborder="0" scrolling="no"></iframe>
