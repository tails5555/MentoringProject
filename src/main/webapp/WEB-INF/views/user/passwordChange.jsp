	...
	<hr style="border: solid 1px" align="center" width="400" />
	  ...
	  <form:form method="post" modelAttribute="user">  
		<div align="center" margin-bottom:10px;>
			<form:input type="text" path="number" placeholder="비밀번호" style="width:350px; padding:5px; margin-bottom:5px" />
		</div>
		<div align="center">
			<form:input type="text" path="number2" placeholder="비밀번호 확인" style="width:350px; padding:5px;margin-bottom:5px" />
		</div>
		<div align="center">
			<button type="submit" class="btn btn-primary" style="width: 350px; padding:5px" >비밀번호 변경</button>
		</div>
